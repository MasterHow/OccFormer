FlowNet2css_checkpoint = 'work_dir/flownet2_frommmof/flownet2-css-ft-sd_8x1_sfine_chairssdhom.pth'
FlowNet2sd_checkpoint = 'work_dir/upload_ready/flownet2/flownet2sd_8x1_slong_chairssdhom_384x448.pth'
model = dict(
    type='FlowNet2',
    flownetCSS=dict(
        type='FlowNetCSS',
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            'work_dir/flownet2_frommmof/flownet2-css-ft-sd_8x1_sfine_chairssdhom.pth'
        ),
        train_cfg=dict(),
        test_cfg=dict()),
    flownetSD=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            'work_dir/upload_ready/flownet2/flownet2sd_8x1_slong_chairssdhom_384x448.pth'
        ),
        train_cfg=dict(),
        test_cfg=dict()),
    flownet_fusion=dict(
